...
if __name__=='__main__':
    ...
    searchPath,aPath,fwdPath=aStar(m,(1,10))
    a=agent(m,1,10,footprints=True,color=COLOR.blue,filled=True)
    b=agent(m,6,4,footprints=True,color=COLOR.yellow,filled=True,goal=(1,10))
    c=agent(m,1,10,footprints=True,color=COLOR.red,goal=(6,4))
    ...
    t2=timeit(stmt='aStar',number=1000,globals=globals())
