from DemoBFS import BFS
from DemoDFS import DFS
from pyamaze import maze,agent,COLOR,textLabel
from timeit import timeit

m=maze(10,10)
#m.CreateMaze(loopPercent=100)
m.CreateMaze(1,10,loopPercent=100)
#m.CreateMaze()
#m.CreateMaze(1,30)
searchPath,dfsPath,fwdDFSPath=DFS(m)
bsearchPath,bfsPath,fwdBFSPath=BFS(m)
...
textLabel(m,'BFS Search Length',len(bsearchPath)+1)
